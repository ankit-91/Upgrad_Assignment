...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        return testRequestQueryService.findBy(RequestStatus.LAB_TEST_COMPLETED); // To obtain all test requests for which lab test is completed
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        // replace this line of code with your implementation
        User loggedInDoctor = userLoggedInService.getLoggedInUser(); // To get currently logged in doctor
        return testRequestQueryService.findByDoctor(loggedInDoctor); // To get all test requests assigned to a given doctor
        //throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            // replace this line of code with your implementation
            User loggedInDoctor = userLoggedInService.getLoggedInUser(); // To get currently logged in doctor
            return testRequestUpdateService.assignForConsultation(id,loggedInDoctor); // To assign a given test request(by id) to a given doctor for consultation
            //throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            // replace this line of code with your implementation
            User loggedInDoctor = userLoggedInService.getLoggedInUser(); // To get currently logged in doctor
            return testRequestUpdateService.updateConsultation(id,testResult,loggedInDoctor);// To update the provided consultation details for a given test request(by id) for a given doctor
            //throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
